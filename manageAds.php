                ...
                <div class="col-12">
                    <div class="row mt-5 justify-content-center">
                        ...
                        <div class="col-12 text-center">
                            <span class="fs-3 fw-bold">Manage Ads</span>
                        </div>
                            ...
                            <div class="row mt-3 g-3">
                                <div class="col-12">
                                    <table class="table table-responsive table-bordered text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            $adsResultSet = Database::search("SELECT * FROM `advertisment` WHERE `user_id` ='". $_SESSION["user"]["id"] ."'");
                                            $adsRows = $adsResultSet->num_rows;

                                            if ($adsRows > 0) {
                                                for ($i = 0; $i < $adsRows; $i++) {
                                                    $ads = $adsResultSet->fetch_assoc();
                                            ?>
                                                    <tr>
                                                        <td><?php echo $ads["title"]; ?></td>
                                                        <td><?php echo $ads["price"]; ?></td>
                                                        <td>
                                                            <a href="viewAd.php?id=<?php echo $ads["id"]; ?>" class="btn btn-primary">View</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                }
